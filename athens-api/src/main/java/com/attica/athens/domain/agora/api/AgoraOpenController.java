...
import com.attica.athens.domain.agora.application.TrendService;
...
public class AgoraOpenController {
    ...
    @GetMapping("/trend")
    public ResponseEntity<ApiResponse<?>> getTrendAgoraUseRedis() {
        List<SimpleAgoraResult> response = trendService.getTrendAgora();
