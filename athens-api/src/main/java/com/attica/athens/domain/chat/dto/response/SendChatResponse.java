...
public record SendChatResponse(Long agoraId, ChatType type, SendChatData data) {

    public SendChatResponse(Long agoraId, AgoraMember agoraMember, Chat chat) {
        this(agoraId, chat.getType(), new SendChatData(chat, agoraMember));
    }
